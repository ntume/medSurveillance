...
public class ListDemographicActivity extends SherlockActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set listener for action item clicked
  		...
  		if (!cd.isConnectingToInternet()) {
    		alert.showAlertDialog(ListDemographicActivity.this, "Internet Connection Error","No working internet connection\n\nUnsynced family cards on the device will be displayed", false);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getSupportMenuInflater().inflate(R.menu.menu_listfamily, menu);
		return true;
	}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.addfamily:
        	Intent addfam = new Intent(getApplicationContext(), DemographicActivity.class);
	        Bundle extras = new Bundle();
    ...
    class GetFamilies extends AsyncTask<String, String, String> {
	    protected void onPreExecute() {
	    	super.onPreExecute();
	    	pDialog = new ProgressDialog(ListDemographicActivity.this);
            pDialog.setMessage("Loading Families...");
	    ...
	    protected String doInBackground(String... params1) {
	    	...
	    	params.add(new BasicNameValuePair("tag", "field_famlies"));
                    ...
                    if (data != null && success.equals("1")) {
                    	Log.d("JSON: xxxx", Integer.toString(data.length()));
                    	 for (int i = 0; i < data.length(); i++) {
                             ...
                             map.put("title", c.getString("famNumber"));
                             map.put("subtitle", c.getString("famType"));
                             map.put("semititle", c.getString("createDate"));
                             map.put("typelist", "family");
                             map.put("IDKey", c.getString("famID"));
	    ...
	    protected void onPostExecute(String aResult) {
	    	...
	    	if(!pList.isEmpty()){
				...
				// Getting adapter by passing  data ArrayList
		        adapter=new GridAdapter(ListDemographicActivity.this, pList);        
		        gridView.setAdapter(adapter);
		        ...
		        gridView.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
							...
							Bundle extras = new Bundle();
					        extras.putString("userID", userID);
					        extras.putString("famID", editP.get("IDKey"));
	    		...
	    		AppMsg.makeText(ListDemographicActivity.this, "Sorry no family cards found please add new family", AppMsg.STYLE_ALERT).show();
    ...
    @Override
   	public void onBackPressed() {		
   		Intent families = new Intent(getApplicationContext(), HomeActivity.class);
   		Bundle extras = new Bundle();
        extras.putString("userID", userID);
